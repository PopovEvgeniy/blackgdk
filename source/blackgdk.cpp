...
unsigned int Frame::get_frame_line() const
{
 return frame_line;
}
...
bool Frame::draw_pixel(const unsigned int x,const unsigned int y,const unsigned int red,const unsigned int green,const unsigned int blue)
{
 bool result;
 size_t offset;
 result=false;
